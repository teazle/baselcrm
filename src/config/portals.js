...
export const PORTALS = {
  ...
  ALLIANCE_MEDINET: {
    ...
    url: process.env.ALLIANCE_MEDINET_URL || '',
  ...
  ALLIANZ: {
    ...
    url: process.env.ALLIANZ_PORTAL_URL || 'https://my.allianzworldwidecare.com/sol/login.do',
    username: process.env.ALLIANZ_PORTAL_USERNAME || '',
    password: process.env.ALLIANZ_PORTAL_PASSWORD || '',
    timeout: 30000,
  },
  FULLERTON: {
    name: 'Fullerton Health',
    url: process.env.FULLERTON_PORTAL_URL || 'https://doctor.fhn3.com/app_index',
    username: process.env.FULLERTON_PORTAL_USERNAME || '',
    password: process.env.FULLERTON_PORTAL_PASSWORD || '',
    timeout: 30000,
  },
  IHP: {
    name: 'IHP eClaim',
    url: process.env.IHP_PORTAL_URL || 'https://eclaim.ihp.com.sg/eclaim/login.asp',
    username: process.env.IHP_PORTAL_USERNAME || '',
    password: process.env.IHP_PORTAL_PASSWORD || '',
    timeout: 30000,
  },
  IXCHANGE: {
    name: 'IXCHANGE SPOS',
    url: process.env.IXCHANGE_PORTAL_URL || 'https://spos.o2ixchange.com/login',
    username: process.env.IXCHANGE_PORTAL_USERNAME || '',
    password: process.env.IXCHANGE_PORTAL_PASSWORD || '',
    timeout: 30000,
  },
  GE_NTUC: {
    name: 'GE / NTUC IM',
    url: process.env.GE_NTUC_PORTAL_URL || '',
    username: process.env.GE_NTUC_PORTAL_USERNAME || '',
    password: process.env.GE_NTUC_PORTAL_PASSWORD || '',
    timeout: 30000,
  },
};
